# Kurzanleitung für den ASMPT Virtual Assist App

Diese Seite führt Sie durch alles, was Sie wissen müssen, um den **ASMPT Virtual Assist App** zu benutzen. Wenn Sie mehr über ASMPT erfahren möchten, lesen Sie ["Was ist ASMPT?"](what-is-knowron.md) Wenn Sie Fragen haben oder Unterstützung benötigen, [wenden Sie sich bitte direkt an uns](mailto:arturo@knowron.com)!

<p align="center"><img src="https://i.imgur.com/EAaxESg.png" width="100%"></p>

---

## Schritt 1. Herunterladen des ASMPT Virtual Assist Apps

Der ASMPT Virtual Assist App ist sowohl für Android- als auch für Apple-Geräte in den jeweiligen App-Stores verfügbar. Der Download ist kostenlos. Klicken Sie einfach auf die unten stehenden Links oder scannen Sie sie mit Ihrem Smartphone.
...
## Schritt 2. Sich in die ASMPT Virtual Assist Web einloggen

Sobald Sie den ASMPT Virtual Assist App öffnen, sehen Sie den Login-Bildschirm (siehe unten).

Sie brauchen nur Ihre E-Mail-Adresse und Ihr ASMPT-Passwort, um sich in das System einzuloggen. Ihre **E-Mail** ist normalerweise Ihre Arbeits-E-Mail. Ihr **Passwort** finden Sie in der E-Mail, die Sie erhalten haben, um Ihrer Organisation auf ASMPT beizutreten (siehe unten).
...
??? info "Haben Sie bereits eine Seriennummer oder einen Maschinen-QR-Code?"
    ...
    Wenn Sie bereits eine Seriennummer oder einen ASMPT QR-Code haben, bedeutet das, dass Ihre Organisation schon etwas länger mit ASMPT arbeitet. Das ist großartig! Alle Ihre Maschinendaten sollten nun für Sie verfügbar sein.

    Tippen Sie zunächst auf das Scan-Bild. Anschließend können Sie die Seriennummer in das dafür vorgesehene Feld eingeben. Alternativ können Sie auch direkt einen ASMPT QR-Code scannen. Tippen Sie einfach auf das Kamerasymbol, um die Kamera zu aktivieren und richten Sie sie direkt auf den QR-Code. Die App sollte Ihr Gerät schnell identifizieren.
...
Jetzt brauchen Sie nur noch zu fragen, was Sie wissen wollen. ASMPT durchsucht dann Ihre gesamte Wissensdatenbank und zeigt Ihnen die wichtigsten Ergebnisse an. Versuchen Sie `Was ist PLA?`.
