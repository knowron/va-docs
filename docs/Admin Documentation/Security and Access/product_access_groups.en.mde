...
??? example
    ...
    Imagine a company, **3D Printers GmbH**. They produce and market 3D printers for the industrial market. They are using ASMPT for their extensive documentation and information delivery needs. 3D Printers GmbH has two divisions, based on their region: **EMEA** and **Americas**. Both of these divisions are under **Global Management**, headquartered in Munich.
    ...
    There are two types of documents Chandler wants to make accessible through ASMPT:
    ...
    Here's where **Product Access Groups** can help: with ASMPT's help, Chandler creates three different access groups:
